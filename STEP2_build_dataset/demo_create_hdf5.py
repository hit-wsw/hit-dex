from dataset_utils_copy import *

dataset_base_dir = '/media/wsw/SSD1T1/save_data_wipe_1-14'
...
output_hdf5_file = '/home/wsw/Dexcap/STEP1_collect_data/1hand_wiping_1-14_{}actiongap_{}points.hdf5'.format(action_gap, num_points_to_sample)
...
process_hdf5(output_hdf5_file, dataset_folders, action_gap, num_points_to_sample, in_wild_data=False)