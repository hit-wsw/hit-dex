...
def read_pose_data(frame_path, demo_path, fixed_trans_to_robot_table, first_frame=False):
    ...
    return (np.concatenate([right_hand_translation, right_hand_quaternion, right_hand_target]),#leap
            np.concatenate([left_hand_translation, left_hand_quaternion, left_hand_target]),#leap
            cam_corrected_pose,
