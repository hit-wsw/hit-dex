...
dataset_base_dir = '/media/wsw/SSD1T1/data/single_hand'
...
output_hdf5_file = '/media/wsw/SSD1T1/data/hand_single_{}ag_{}points.hdf5'.format(action_gap, num_points_to_sample)
