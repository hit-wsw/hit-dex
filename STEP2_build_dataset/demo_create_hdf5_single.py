from dataset_utils_single import *

dataset_base_dir = '/media/wsw/SSD1T1/data/save_wipe_1-14'
...
output_hdf5_file = 'STEP1_collect_data/hand_wiping_single_{}actiongap_{}points.hdf5'.format(action_gap, num_points_to_sample)
