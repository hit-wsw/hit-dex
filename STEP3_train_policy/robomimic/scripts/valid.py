...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default='/home/wsw/Dexcap/STEP3_train_policy/robomimic/training_config/diffusion_policy_pcd_wiping_1-14.json',
    ...
    parser.add_argument(
        "--resume",
        type=str,
        default='/media/wsw/SSD1T/data/model_epoch_500.pth',
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default='/media/wsw/SSD1T/data/hand_wiping_1-14_5actiongap_10000points.hdf5',
