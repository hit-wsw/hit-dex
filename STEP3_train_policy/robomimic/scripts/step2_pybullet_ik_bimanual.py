...
from step2_hyperparameters import *
...
class LeapPybulletIK():
    def __init__(self):
        ...
        self.LeapId = p.loadURDF(
            "/home/wsw/Dexcap/STEP2_build_dataset/leap_hand_mesh/robot_pybullet.urdf",
            [0.0, 0.0, 0.0],
        ...
        self.urdf_dict = {}
        self.Leap_urdf = URDF.load("/home/wsw/Dexcap/STEP2_build_dataset/leap_hand_mesh/robot_pybullet.urdf")
        self.Leap_urdf_2 = URDF.load("/home/wsw/Dexcap/STEP2_build_dataset/leap_hand_mesh/robot_pybullet.urdf")
    ...
    def _load_meshes(self, scene):
        ...
        for name, g in scene.geometry.items():
            # 直接使用 Trimesh 对象 g
            mesh = g  # mesh 已经是 Trimesh 对象，无需再调用 as_mesh()
    
            # 创建一个空的 Open3D 三角形网格
            o3d_mesh = o3d.geometry.TriangleMesh()

            # 将 Trimesh 数据传递给 Open3D
            o3d_mesh.vertices = o3d.utility.Vector3dVector(np.copy(mesh.vertices))
            o3d_mesh.triangles = o3d.utility.Vector3iVector(np.copy(mesh.faces))
    ...
    def vis_hand(self, right_hand_pos, right_hand_wrist_ori, right_hand, left_hand_pos, left_hand_wrist_ori, left_hand):
        p.stepSimulation()
        ...
        jointPoses_2 = tuple(left_hand)
        jointPoses = tuple(right_hand)
        ...
        return right_hand_pointcloud, left_hand_pointcloud
